...
channel_df["change_pct"] = channel_df.apply(
    lambda r: pct_change(r["today_buzz"], r["yesterday_buzz"]), axis=1
)
...
df_top_channel["engagement"] = (
    df_top_channel["Reactions"]
    + df_top_channel["Shares"]
    + df_top_channel["Comments"]
)
...
- Chỉ được dùng URL_X trong danh sách
- Mỗi URL_X chỉ dùng 1 lần
- Tuyệt đối không ghi URL thật
...
# =====================
# POST-PROCESS: REPLACE KEY -> REAL URL
# =====================
...
# =====================
# FINAL SLIDE JSON (INSIGHT = 1 VALUE)
# =====================
slide_3 = {
