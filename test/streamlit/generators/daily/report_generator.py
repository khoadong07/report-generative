...
try:
    ...
    from generators.daily.slide_generators import (
        Slide1Generator,
        Slide2Generator,
        Slide3Generator,
        Slide4Generator,
...
class ReportGenerator:
    ...
    def __init__(self, api_key: str, base_url: str, file_path: str = None, 
        ...
        Args:
            ...
            show_interactions: Show interaction metrics for slides 5&6 (default: True)
        """
    ...
    def generate_report(self) -> Dict[str, Any]:
        ...
        # Generate Slide 6 only if show_interactions=True
        slide6_data = None
        if self.show_interactions:
            ...
            print("      [Slide 6] ⏭️  Skipped (show_interactions=False)")
        ...
        report = {
            "report_metadata": {
                ...
                "total_slides": 6 if self.show_interactions else 5
            },
        ...
        # Add slide 6 only if interactions are enabled
        if self.show_interactions and slide6_data:
            report["slide_6"] = slide6_data
        
        print("      ✅ Report structure created")
        
        print("\n" + "="*60)
        if self.show_interactions:
            print("✅ REPORT GENERATION COMPLETED! (6 slides)")
        else:
            print("✅ REPORT GENERATION COMPLETED! (5 slides - no interactions)")
        print("="*60)
