...
class Slide01Overview(SlideGenerator, InsightMixin):
    ...
    def _metrics_with_interactions(self, w1: pd.DataFrame, w2: pd.DataFrame) -> List[Dict]:
        ...
        return [
            ...
            {"label": "Tổng lượt xem",  "value": views, "change_percent": _chg(views, p_views)},
            {"label": "Lượt reactions", "value": react, "change_percent": _chg(react, p_react)},
            {"label": "Lượt chia sẻ",   "value": shr,   "change_percent": _chg(shr,   p_shr)},
            {"label": "Lượt bình luận", "value": cmt,   "change_percent": _chg(cmt,   p_cmt)},
        ]
